...
public class ExcelReader {
	...
	public String getCellData(String sheetName,String colName,int rowNum, CellType BOOLEAN){
		try{
			if(rowNum <=0)
				return "";
		...
		if(cell.getCellType()==STRING)
			  ...
			  return String.valueOf(cell.getCellType()==BOOLEAN);
